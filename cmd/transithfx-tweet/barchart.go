...
// Copied from gonum.org/v1/plot/plotter.BarChart to add YMin support.
// This version does assume values will be 0 or positive.
...
func (b *BarChart) DataRange() (xmin, xmax, ymin, ymax float64) {
	...
	for i, val := range b.Values {
		...
		valTop := valBot + val
		valMin = math.Max(valMin, math.Min(valBot, valTop))
